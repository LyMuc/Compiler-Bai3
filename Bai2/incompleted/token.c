...
struct {
  ...
  {"TO", KW_TO}, 
  {"STRING", KW_STRING},
  {"BYTES", KW_BYTES},  // <--- THÊM DÒNG NÀY
  {"REPEAT", KW_REPEAT}, // <--- THÊM DÒNG NÀY
  {"UNTIL", KW_UNTIL}    // <--- THÊM DÒNG NÀY
};
...
char *tokenToString(TokenType tokenType) {
  ...
  case KW_REPEAT: return "keyword REPEAT"; // <--- THÊM DÒNG NÀY
  case KW_UNTIL: return "keyword UNTIL";   // <--- THÊM DÒNG NÀY
  case KW_STRING: return "keyword STRING";
  case KW_BYTES: return "keyword BYTES";   // <--- THÊM DÒNG NÀY
  ...
  case SB_MOD: return "\'%\'";           // <--- THÊM DÒNG NÀY
  case SB_POWER: return "\'**\'";        // <--- THÊM DÒNG NÀY
  case SB_LPAR: return "\'(\'";
  case SB_RPAR: return "\')\'";
  case SB_LSEL: return "\'(.\'";
  case SB_RSEL: return "\'.)\'";
